 ...
 * @author gustavo
 */
public class AreaPentagono extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Área pentágono");

        jLabel1.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Área Pentágono");
        ...
        txtPerimetro.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtPerimetroKeyTyped(evt);
            }
        });

        txtApotema.setToolTipText("");
        txtApotema.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtApotemaKeyTyped(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtApotema, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void txtPerimetroKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPerimetroKeyTyped
        
        char tecla;
        tecla = evt.getKeyChar();
        String cod = txtPerimetro.getText();
    ...
    }//GEN-LAST:event_txtPerimetroKeyTyped

    private void txtApotemaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtApotemaKeyTyped
        char tecla;
        tecla = evt.getKeyChar();
        String cod = txtApotema.getText();
        int punto = cod.indexOf(".")+1;
    ...
    }//GEN-LAST:event_txtApotemaKeyTyped
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        double resultado = areaPentagono(perimetro, apotema);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AreaPentagono.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AreaPentagono().setVisible(true);
            }
        });
    }
