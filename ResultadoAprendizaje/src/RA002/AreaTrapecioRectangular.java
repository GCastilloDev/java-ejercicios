 ...
 * @author gustavo
 */
public class AreaTrapecioRectangular extends javax.swing.JFrame {

    /**
     * Creates new form AreaTriangulo
     */
    public AreaTrapecioRectangular() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Área de trapecio rectangular");

        jLabel1.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Área Trapecio Rectangular");
    ...
    public double areaTrapecioRectangular (double baseMayor, double baseMenor, double lado){
        double resultado =  ( (baseMenor + baseMayor) * lado ) / 2;
        return resultado;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AreaTrapecioRectangular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AreaTrapecioRectangular().setVisible(true);
            }
        });
    }
